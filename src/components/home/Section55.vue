...
@media only screen and (max-width: 767px){
  ...
  .swiper::v-deep .title, .swiper::v-deep .innovate, .swiper::v-deep .slideText {
    margin: 0;
  }
  .swiper::v-deep p.slide-text-p, .swiper::v-deep .text {
    margin-left: 0;
    margin-right: 0;
    max-width: 260px;
    text-align: center;
