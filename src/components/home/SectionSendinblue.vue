...
export default {
  ...
  mounted () {
    ...
    const sendinblueScript = document.createElement('script')
    sendinblueScript.src = 'https://sibforms.com/forms/end-form/build/main.js'
    document.body.appendChild(sendinblueScript)
