<template>
<div v-if="content">
      <b-nav-item to="/join-us" class="joinUsButton"><button v-b-toggle.nav-collapse @click="noScroll();" class="text-info"><a data-toggle="collapse" href="#nav-collapse" class="call-button-text">contact us</a></button></b-nav-item>
